...
# CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 opengait/main.py --cfgs ./configs/pruegait/pruegait_casiab.yaml --phase test --log_to_file
